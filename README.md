...
with authentication and thread organization.
...
- Retrieve relevant veterinary knowledge, through the external Vet Notes RAG app, before answering.
...
│   ├── retrieval_service.py    # Communication point with VetRAG
...
If the available information from the user is insufficient, the system may ask clarifying questions first.
